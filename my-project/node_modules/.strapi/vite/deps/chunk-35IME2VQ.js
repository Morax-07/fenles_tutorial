...
// node_modules/@strapi/plugin-cloud/dist/admin/chunks/index--dqXZZcY.mjs
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-DHxfjovA-WSE4BZFE.js");
    case "./translations/fr.json":
      return import("./fr-XFxvAMHP-42D7QSV6.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-BcMkGcCg-UGBNCCTO.js");
          return App;
        }
      });
      const plugin = {
...
//# sourceMappingURL=chunk-35IME2VQ.js.map
